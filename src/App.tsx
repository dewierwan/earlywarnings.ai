...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-indigo-100 dark:from-gray-900 dark:to-indigo-950 p-3 sm:p-4 md:p-6 theme-transition">
      ...
      <div className="min-h-[450px] sm:min-h-[420px] md:min-h-[400px]">
        {currentQuote && (
          <div className="max-w-4xl mx-auto mb-8 sm:mb-12 px-0 sm:px-4">
          <div 
            className={`bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 shadow-lg border border-gray-200 dark:border-gray-700 transition-opacity duration-1000 theme-transition hover:shadow-xl cursor-pointer active:scale-[0.995] transform hover:border-indigo-300 dark:hover:border-indigo-500 ${
